...
const MovieDetails = () => {
  ...
  useEffect(() => {
    fetch(
      `https://api.themoviedb.org/3/movie/${id}?api_key=4f298a53e552283bee957836a529baec&language=en-US`
    )
      ...
      .then((response) => {
        ...
        fetch(
          `https://api.themoviedb.org/3/movie/${id}/credits?api_key=4f298a53e552283bee957836a529baec`
        )
          .then((response) => response.json())
          .then((response) => {
